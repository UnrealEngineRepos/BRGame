...
// OnHealthChanged event to respond to changes in the health
...
UCLASS( ClassGroup=(BRGAME), meta=(BlueprintSpawnableComponent) )
class BRGAME_API USHealthComponent : public UActorComponent
{
	GENERATED_BODY()
